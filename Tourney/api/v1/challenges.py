...
from Tourney.api.v1.helpers.request import validate_args
from Tourney.api.v1.helpers.schemas import sqlalchemy_to_pydantic
from Tourney.api.v1.schemas import APIDetailedSuccessResponse, APIListSuccessResponse
from Tourney.cache import cache, clear_challenges, clear_ratings, clear_standings
from Tourney.constants import RawEnum
from Tourney.exceptions.challenges import (
    ChallengeCreateException,
    ChallengeSolveException,
    ChallengeUpdateException,
)
from Tourney.models import ChallengeFiles as ChallengeFilesModel
from Tourney.models import Challenges
from Tourney.models import ChallengeTopics as ChallengeTopicsModel
...
from Tourney.plugins.challenges import CHALLENGE_CLASSES, get_chal_class
from Tourney.schemas.challenges import ChallengeSchema
from Tourney.schemas.flags import FlagSchema
from Tourney.schemas.hints import HintSchema
from Tourney.schemas.ratings import RatingSchema
from Tourney.schemas.tags import TagSchema
from Tourney.utils import config, get_config
from Tourney.utils import user as current_user
from Tourney.utils.challenges import (
    get_all_challenges,
...
from Tourney.utils.config.visibility import (
    accounts_visible,
    challenges_visible,
    scores_visible,
)
from Tourney.utils.dates import ctf_ended, ctf_paused, ctftime, isoformat
...
from Tourney.utils.humanize.words import pluralize
from Tourney.utils.logging import log
from Tourney.utils.security.signing import serialize
from Tourney.utils.user import (
    authed,
    get_current_team,
    ...
    def post(self):
        ...
        if current_user.is_admin():
            ...
            if preview:
                ...
                # TODO: Tourney 4.0 We should remove the tuple strategy for Challenge plugins in favor of ChallengeResponse
