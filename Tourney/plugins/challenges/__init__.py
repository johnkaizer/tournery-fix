...
from Tourney.plugins import register_plugin_assets_directory
from Tourney.plugins.challenges.decay import DECAY_FUNCTIONS, logarithmic
from Tourney.plugins.challenges.logic import (
    challenge_attempt_all,
    challenge_attempt_any,
    challenge_attempt_team,
)
from Tourney.utils.uploads import delete_file
from Tourney.utils.user import get_ip
...
class ChallengeResponse:
    ...
    def __iter__(self):
        ...
        # TODO: Tourney 4.0 remove this behavior as we should move away from the tuple strategy
...
class TourneyStandardChallenge(BaseChallenge):
...
"""
Global dictionary used to hold all the Challenge Type classes used by Tourney. Insert into this dictionary to register
your Challenge Type.
"""
CHALLENGE_CLASSES = {"standard": TourneyStandardChallenge}
